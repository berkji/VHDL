...
HD_PWD='D:/work/VHDL/lab5/lab5_1/lab5_1.runs/design_1_rst_clk_wiz_0_83M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_0_83M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_0_83M_0.tcl
