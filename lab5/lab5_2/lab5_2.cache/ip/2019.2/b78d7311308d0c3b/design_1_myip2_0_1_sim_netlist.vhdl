...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_handshake_0 is
  ...
  attribute MARK_DEBUG of state_dest : signal is std.standard.true;
  attribute syn_keep of state_dest : signal is "TRUE";
  signal \state_dest[0]_i_1__0_n_0\ : STD_LOGIC;
  signal \state_dest[1]_i_1__0_n_0\ : STD_LOGIC;
  signal state_src : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute MARK_DEBUG of state_src : signal is std.standard.true;
  attribute syn_keep of state_src : signal is "TRUE";
  signal \state_src[0]_i_1__0_n_0\ : STD_LOGIC;
  signal \state_src[1]_i_1__0_n_0\ : STD_LOGIC;
  attribute KEEP : string;
  attribute KEEP of ack_s_reg : label is "yes";
  attribute mark_debug_string : string;
  attribute mark_debug_string of ack_s_reg : label is "true";
...
\ack_s_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F8FF08F0"
    )
        port map (
...
\send_s_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8BBB8BBB88BB8888"
    )
        port map (
...
\state_dest[0]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F8880444"
    )
        port map (
      ...
      I3 => state_dest(1),
      I4 => state_dest(0),
      O => \state_dest[0]_i_1__0_n_0\
    );
\state_dest[1]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FCCC0AAA"
    )
        port map (
...
\state_dest_reg[1]\: unisim.vcomponents.FDCE
     port map (
      ...
      CE => '1',
      CLR => AR(0),
      D => \state_dest[1]_i_1__0_n_0\,
      Q => state_dest(1)
    );
\state_src[0]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FF99999900505050"
    )
        port map (
      ...
      I4 => state_src(1),
      I5 => state_src(0),
      O => \state_src[0]_i_1__0_n_0\
    );
\state_src[1]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAA0888"
    )
        port map (
