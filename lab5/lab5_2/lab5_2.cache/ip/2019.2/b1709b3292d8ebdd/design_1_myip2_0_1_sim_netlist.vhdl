...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_memory_map is
  ...
  attribute MARK_DEBUG of \^rd_data\ : signal is std.standard.true;
...
rd_data_inferred_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
rd_data_inferred_i_16: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => rd_data_sel,
      I1 => mem_out_rd_data(2),
      O => \^rd_data\(2)
    );
rd_data_inferred_i_17: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
rd_data_inferred_i_18: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => rd_data_sel,
      I1 => mem_out_rd_data(0),
      O => \^rd_data\(0)
    );
...
rd_data_inst: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_data_inst__0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_data_inst__1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_data_inst__2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_data_inst__3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_data_inst__4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\rd_data_inst__5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
