...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_addr_gen_out is
  ...
  signal \next_state_reg[1]__0_i_3_n_0\ : STD_LOGIC;
  signal \next_state_reg[1]_i_2_n_0\ : STD_LOGIC;
  signal \next_state_reg[1]_i_3_n_0\ : STD_LOGIC;
  signal \next_state_reg[2]__0_i_1_n_0\ : STD_LOGIC;
  signal \next_state_reg[2]__0_i_2_n_0\ : STD_LOGIC;
  signal \next_state_reg[2]__0_i_3_n_0\ : STD_LOGIC;
  signal \next_state_reg[2]_i_2_n_0\ : STD_LOGIC;
  signal \next_state_reg[2]_i_3_n_0\ : STD_LOGIC;
  signal \next_state_reg[2]_i_4_n_0\ : STD_LOGIC;
  signal \next_state_reg[2]_i_5_n_1\ : STD_LOGIC;
  signal \next_state_reg[2]_i_5_n_2\ : STD_LOGIC;
  signal \next_state_reg[2]_i_5_n_3\ : STD_LOGIC;
  ...
  signal \NLW_next_state_reg[2]_i_5_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_next_state_reg[2]_i_5_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute KEEP : string;
  attribute KEEP of \addr_s_reg[0]\ : label is "yes";
  attribute syn_keep of \addr_s_reg[0]\ : label is "TRUE";
  attribute KEEP of \addr_s_reg[1]\ : label is "yes";
...
\next_state_reg[1]__0_i_1\: unisim.vcomponents.MUXF7
     port map (
      I0 => \next_state_reg[1]__0_i_2_n_0\,
      I1 => \next_state_reg[1]__0_i_3_n_0\,
      O => \next_state_reg[1]__0_i_1_n_0\,
      S => state(2)
    );
\next_state_reg[1]__0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8BCC03888BFF0388"
    )
        port map (
      I0 => en,
      I1 => state(1),
      I2 => \next_state_reg[2]_i_5_n_1\,
      I3 => state(0),
      I4 => next_state(1),
      I5 => go,
      O => \next_state_reg[1]__0_i_2_n_0\
    );
\next_state_reg[1]__0_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
...
\next_state_reg[1]_i_1\: unisim.vcomponents.MUXF7
     port map (
...
\next_state_reg[2]__0_i_1\: unisim.vcomponents.MUXF7
     port map (
      I0 => \next_state_reg[2]__0_i_2_n_0\,
      I1 => \next_state_reg[2]__0_i_3_n_0\,
      O => \next_state_reg[2]__0_i_1_n_0\,
      S => state(2)
    );
\next_state_reg[2]__0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"B8443000B8773000"
    )
        port map (
      I0 => en,
      I1 => state(1),
...
\next_state_reg[2]__0_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
    )
        port map (
...
\next_state_reg[2]_i_1\: unisim.vcomponents.MUXF7
     port map (
...
\next_state_reg[2]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
    )
        port map (
...
\next_state_reg[2]_i_5\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \NLW_next_state_reg[2]_i_5_CO_UNCONNECTED\(3),
      CO(2) => \next_state_reg[2]_i_5_n_1\,
      CO(1) => \next_state_reg[2]_i_5_n_2\,
      CO(0) => \next_state_reg[2]_i_5_n_3\,
      CYINIT => '1',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_next_state_reg[2]_i_5_O_UNCONNECTED\(3 downto 0),
      S(3) => '0',
...
\next_state_reg[2]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
