...
--    attribute mark_debug of reg_go : signal is "true";  
    
--    attribute syn_keep of reg_size : signal is true;
--    attribute mark_debug of reg_size : signal is "true";  
        
--    attribute syn_keep of reg_rd_data : signal is true;
--    attribute mark_debug of reg_rd_data : signal is "true";  
    
--    attribute syn_keep of rd_data_sel : signal is true;
--    attribute mark_debug of rd_data_sel : signal is "true";  
...
--    process(clk, rd_data_sel)
--    begin
--    if (clk='1' and clk'event) then
--        if rd_data_sel = C_RD_DATA_SEL_MEM_OUT then
--            rd_data <= std_logic_vector(to_unsigned(0, C_MMAP_DATA_WIDTH-C_MEM_OUT_WIDTH))&mem_out_rd_data;
--        else 
--            rd_data <= reg_rd_data;
--        end if;
--    end if;
...
--    rd_data <="10101010101010101010101010101010"; 
